...
namespace DevelopersChallenge2.Api.Controllers.Tests
{
    [TestClass()]
...
<BANKTRANLIST>
<DTSTART>20140215100000[-03:EST]
<DTEND>20140231100000[-03:EST]
<STMTTRN>
<TRNTYPE>DEBIT
<DTPOSTED>20140212100000[-03:EST]
<TRNAMT>-95.00
...
<DTASOF>20140318100000[-03:EST]
        ...
        [TestMethod()]
        public void ReconcileBankStatementTest()
        {
            ImportController importController = new ();
            var result = importController.ReconcileBankStatement(data);
            Assert.IsNotNull(result);
            Assert.AreEqual(((List<Entities.BankTransaction>)((Microsoft.AspNetCore.Mvc.ObjectResult)result).Value).Count, 34);
        }
    }
}